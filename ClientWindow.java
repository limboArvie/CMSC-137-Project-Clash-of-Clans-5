...
public class ClientWindow extends JFrame implements Runnable,WindowListener{
			...
			public void run() {
				while (running) {
					...
					if (message.startsWith("/c/")) {
						...
						text = text.split("/e/")[0];
						int tempPlace = Integer.parseInt(text);
						place = tempPlace;
						client.place = tempPlace;

						//gamePane.updateHookImage(place);
					} else if (message.startsWith("/a/")){
						//System.out.println("attack: "+message);
					}
				}
			}
		};
